...
class CaseSpider(scrapy.Spider):
    ...
    first_headers = {
        ...
        'Connection': 'keep-alive',
        'Referer': 'https://www.courts.state.md.us/',
        ...
        'sec-ch-ua-arch': '"x86"',
        'sec-ch-ua-full-version-list': '".Not/A)Brand";v="99.0.0.0", "Google Chrome";v="103.0.5060.66", "Chromium";v="103.0.5060.66"',
        'sec-ch-ua-mobile': '?0',
        'sec-ch-ua-model': '""',
        'sec-ch-ua-platform': '"Windows"',
    }
    ...
    def get_next_letters_last(self):
        if not self.last:
    ...
    def next_request(self):
        ...
        try:
            self.get_next_letters_last()
        except LettersExhausted:
            return
        page_url = f"https://casesearch.courts.state.md.us/casesearch/inquiry-results.jsp?d-16544-p=1&lastName={self.last}%25&filingDate=&filingEnd=7%2F6%2F2022&partyType=DEF&courtSystem=B&courttype=N&firstName=&site=TRAFFIC&searchTrialPersonAction=Search&filingStart=7%2F1%2F2022&company=N&middleName=&countyName="
    ...
    def parse_results_page(self, response):
        ...
        with open(f"{self.last}.html", "w") as f:
        ...
        if next_link:
            ...
            # Restart the process with the next letter
            yield self.next_request()
    ...
    def parse_traffic_page(self, response):
